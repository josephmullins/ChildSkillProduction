...
\begin{landscape}
    ...
    \begin{table}\footnotesize\caption{Direct GMM Estimation - Relaxed Demand Specification}
        \begin{center}
            ...
            \captionsetup{width=\textwidth}
            \caption*{This reports the 10th and 90th percentiles of the bootstrapped distribution of parameter estimates from the direct estimation method. To avoid convergence issues, each bootstrap trial is terminated after 100 LBFGS iterations followed by 10 iterations of Newton's method.}
        \end{center}
    \end{table}        

...
\begin{landscape}
    \begin{table}\footnotesize\caption{\label{res1}Joint GMM Estimation - Fully Restricted Case, No Binding Constraints}
        \begin{center}
    ...
    \begin{table}\footnotesize\caption{\label{res2}Joint GMM Estimation - Fully Restricted Case, No Borrowing or Saving}
        \begin{center}
    ...
    \begin{table}\footnotesize\caption{\label{res3}Joint GMM Estimation - Unrestricted, No Binding Constraints}
        \begin{center}
